...
This is a sample template for house_control - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name house_control --query 'Stacks[].Outputs'
```
