...
This is a sample template for TrainDelay - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name traindelay --query 'Stacks[].Outputs'
```
